...
//
//  Contents.swift
//  Created by Jatin Gangwani on 18/03/2019.
//  Copyright © 2019 Jatin Gangwani. All rights reserved.
//
...
/*:
 ...
 Hi! I'm **Jatin Gangwani**, a student of Macro Vision Academy(Apple Distinguished School), Burhanpur, M.P, India. I've devoted to iOS development since 2017 and this year, I made some digging into the latest `ARKit` and `Machine Learnign`, which is awesome and easy to use! So I created a Ai Scanner project for WWDC 2019 scholarship submission. Hope you like it! 😊
